...
function atualizaProgresso() {
    ...
    numeroPergunta.textContent =
        `${String(numeroAtual).padStart(2, "0")} / ${String(total).padStart(2, "0")}`;
...
function mostraResultado() {
    ...
    document.querySelector(".progresso-container").style.display =
        "none";


    document.querySelector(".label-pergunta").style.display =
        "none";
