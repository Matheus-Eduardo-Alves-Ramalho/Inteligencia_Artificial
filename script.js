...
const perguntas = [
    {
        ...
        alternativas: [
            ...
            },
            {
                ...
                afirmacao: "Você se destaca pelo <b>dinamismo</b>, gostando de aprender e ajustar durante o processo."
            }
        ]
    },
    {
...
function atualizaProgresso() {
    ...
    const porcentagem = (numeroAtual / total) * 100;

    numeroPergunta.textContent = `${String(numeroAtual).padStart(2, "0")} / ${String(total).padStart(2, "0")}`;
...
function respostaSelecionada(opcaoSelecionada) {
    historiaFinal += opcaoSelecionada.afirmacao + "<br><br>";
    atual++;
    mostraPergunta();
}
...
function mostraResultado() {
    ...
    document.querySelector(".progresso-container").style.display = "none";
    document.querySelector(".label-pergunta").style.display = "none";
